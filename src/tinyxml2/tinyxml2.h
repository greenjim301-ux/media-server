...
public:
	...
	void Trace(const char *name) {
		printf("Mempool %s watermark=%d [%dk] current=%d size=%d nAlloc=%d blocks=%d\n", name,
		       _maxAllocs, _maxAllocs * ITEM_SIZE / 1024, _currentAllocs, ITEM_SIZE, _nAllocs,
		       _blockPtrs.Size());
	}
...
public:
	...
	// ChildElementCount was originally suggested by msteiger on the sourceforge page for TinyXML
	// and modified by KB1SPH for TinyXML-2.
